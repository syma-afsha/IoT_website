    ...
    var calculatedStyle = (0, react_1.useMemo)(function () {
        ...
        return isSSR
            ...
            : currentPage === page // for current (out)
                ? __assign({}, (0, utils_1.computeStyle)((_a = animation === null || animation === void 0 ? void 0 : animation.out) === null || _a === void 0 ? void 0 : _a.style, currentProgress))
                : currentPage === page - 1 // for next (in)
                    ? __assign({}, (0, utils_1.computeStyle)((_b = animation === null || animation === void 0 ? void 0 : animation.in) === null || _b === void 0 ? void 0 : _b.style, currentProgress))
                    : { display: "none" };
    }, [
        isSSR,
        currentPage,
